...
const Todo = (props) => {
    ...
    const iconNameString = iconName.length === 2 ? "https://ui-avatars.com/api/?rounded=true&size=32&name=" + iconName[0] + "+" + iconName[1] : "https://ui-avatars.com/api/?rounded=true&size=32&name=" + iconName[0]
